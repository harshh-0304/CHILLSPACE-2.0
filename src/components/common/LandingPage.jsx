                ...
                <div className="row">
                  <div className="col-md-6 ">
                    <div className="detail_box">
                      <h1>ChillSpace</h1>
                      <p>Welcome to <strong>ChillSpace</strong> – the ultimate destination for hassle-free stays. Find unique accommodations, connect with verified hosts, and enjoy seamless booking experiences—all in one place.</p>
