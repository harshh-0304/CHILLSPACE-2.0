            ...
            <form onSubmit={handleSubmit(submitHandler)}>
                  ...
                  {amenitiesList.map((amenity) => (
                    <span key={amenity} style={{paddingRight:"8px"}}>
                      <input
                        type="checkbox"
                        value={  amenity }
                        onChange={handleAmenityChange}   id={amenity}
                      />
                      <label htmlFor={amenity} style={{paddingLeft:"8px"}}> {amenity}</label>
                    </span>
                  ))}
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  type="number"
                  className="form-control"
                  {...register("availableRooms", { required: "Room Number is required." })}
